...
def run_regression(features, target, target_name, layer):
    ...
    for n_comp in n_comp_list:
        ...
        for train_index, test_index in kf.split(features):
            ...
            # Lasso
            param_grid1 = {'alpha': np.arange(0.01, 1, 0.01),'max_iter': [10000]}
            # SVR
            param_grid2 = {'C': [0.1, 1, 10], 'kernel': ['linear', 'rbf'], 'gamma': ['scale', 0.1, 0.01, 0.001]}
    
            
            # search best hyperparameter 
            grid_search = GridSearchCV(model1, param_grid1, scoring='r2', cv=10, n_jobs=20)
        ...
        res_dict["parameters"] = best_params
